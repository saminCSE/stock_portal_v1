...
<main>
    ...
    <div class="main_panel" style="height: calc(100vh - 150px); position:relative">
        ...
        <div class="content-container" style="position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%); text-align:center">
                <h2 class="text-center">Incorrect Verification Link!</h2>
                <p class="text-center mt-3" style="font-size: 20px">The verification link you provided is incorrect. Please make sure you are using the correct link to complete the verification process.</p>
