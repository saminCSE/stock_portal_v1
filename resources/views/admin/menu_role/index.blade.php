                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                        ...
                        @foreach($collections as $key=>$value)
                            ...
                            <tr class="row1" data-id="{{ $id }}">
                                ...
                                {{-- @if(Auth()->user()->can('rolemenu edit')) --}}
                                    <a href="{{url(config('siteconfig.adminRoute').'/rolemenu/'.$value->role_id.'/edit')}}"
                                ...
                                {{-- @if(Auth()->user()->can('rolemenu delete'))   --}}  
                                    {!! Form::open(['route' => ["rolemenu.destroy",$value->role_id], 'method'=>'delete',  'style'=>'display:inline']) !!}
